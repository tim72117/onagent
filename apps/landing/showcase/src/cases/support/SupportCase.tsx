  ...
  return (
    <div className={shared.caseSplit}>
          ...
          <div className={styles.phone}>
            ...
            <div className={styles.screen}>
              ...
              <div className={styles.thread}>
                <span className={`${styles.msg} ${styles.fromUser}`} style={{ animationDelay: '0.2s' }}>Is Amy free on Tuesday?</span>
                <div className={styles.tool} style={{ animationDelay: '1.1s' }}>
                  <span>⚙ check_availability(stylist: "Amy")</span>
                  <span className={styles.toolResult}>→ Tue, 2pm: available</span>
                </div>
                <span className={`${styles.msg} ${styles.fromAi}`} style={{ animationDelay: '2.0s' }}>Yes — Tue, 2pm is open with Amy. Want me to book it?</span>
                <span className={`${styles.msg} ${styles.fromUser}`} style={{ animationDelay: '2.9s' }}>Yes please!</span>
      ...
      <div className={shared.caseContent}>
        ...
        <p>Drop a chat assistant into your site that checks real-time availability, books appointments, and hands off to a human when it should.</p>
        <div className={shared.chat}>
          <span className={shared.bubbleU}>Is Amy free on Tuesday?</span>
          <span className={shared.bubbleU}>What appointments do I have?</span>
